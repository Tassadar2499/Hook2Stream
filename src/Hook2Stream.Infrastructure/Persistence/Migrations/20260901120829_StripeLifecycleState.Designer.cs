...
namespace Hook2Stream.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260901120829_StripeLifecycleState")]
    partial class StripeLifecycleState
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hook2Stream.Domain.BillingCheckout", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ProviderAccessRevokedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("provider_access_revoked_at");
                    ...
                    b.Property<DateTimeOffset?>("SubscriptionAccessEndedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("subscription_access_ended_at");
            ...
            modelBuilder.Entity("Hook2Stream.Domain.Entitlement", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ProviderEventOccurredAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("provider_event_occurred_at");
