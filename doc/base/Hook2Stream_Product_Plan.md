...
> Статус: утверждённая концепция для concierge validation и MVP
...
Вердикт: **GO к concierge validation**, затем к self-service MVP только после пяти реальных оплат.
